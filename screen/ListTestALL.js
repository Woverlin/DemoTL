...
export default class ListTestAll extends Component {
  ...
  test1() {
    this.checkAlert.alert("Mẹo",
      ...
      [
        { text: "Bắt đầu", onPress: () => { this.props.navigation.navigate('TestAllPart1') } },
  ...
  test2() {
    this.checkAlert.alert("Mẹo",
      ...
      [
        { text: "Bắt đầu", onPress: () => { this.props.navigation.navigate('TestAllPart2') } },
        { text: "Để sau", onPress: () => console.log("Cancel touch") }
      ])
  }
  test3() {
  ...
  test7() {
    this.checkAlert.alert("Mẹo",
      ...
      [
        { text: "Bắt đầu", onPress: () => { this.props.navigation.navigate('TestAllPart7') } },
        { text: "Để sau", onPress: () => console.log("Cancel touch") }
      ])
  }
  render() {
