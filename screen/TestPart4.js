          ...
          this.getLink(dataSnapshot.val().linktalk)
            .then((html) => {
              let item = {
                ...
                question1: dataSnapshot.val().question7,
                question2: dataSnapshot.val().question8,
                question3: dataSnapshot.val().question9,
                result1: dataSnapshot.val().result7,
                result2: dataSnapshot.val().result8,
                result3: dataSnapshot.val().result9,
                audio,
                html,
              };
              this.setState({
